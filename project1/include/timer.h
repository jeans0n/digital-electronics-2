...
#define TIM0_overflow_16us()    TCCR0B &= ~((1<<CS02) | (1<<CS01); TCCRB0 |= (1<<CS00));

#define TIM0_overflow_128us()    TCCR0B &= ~((1<<CS02) | (1<<CS00); TCCRB0 |= (1<<CS01));
...
#define TIM0_overflow_interrupt_disable() TIMSK0 &= ~(1<<TOIE0);
   ...
   #define TIM2_overflow_16us()   TCCR2B &= ~((1<<CS22) | (1<<CS21)); TCCR1B |= (1<<CS20);
